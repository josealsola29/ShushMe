package com.example.jalsola.places;
...
import com.example.jalsola.places.provider.PlaceContract;
...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Iniciar the switch state and handle enable/disable  switch change
    ...
    public void onResume() {
        ...
        if (android.os.Build.VERSION.SDK_INT >= 24 && !Objects.requireNonNull(nm).isNotificationPolicyAccessGranted()) {
